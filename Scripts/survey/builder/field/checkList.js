...
(function ($) {
    ...
    if (window.__localization) { $.extend(options, __localization.checkList_js); }
    ...
    */
    ...
    yardi.extend(checkList, yardi.baseField, {
        ...
        buildHtml: function () {
            ...
            html.push('<input #{sync}="' + this.indexKey + '" name="#{n}" id="' + this.getInputId() + '" type="checkbox" value="' + options.firstOption + '"/>');
            html.push('<label #{sync}="' + this.indexKey + '" for="' + this.getInputId() + '" empty="false" class="custext">' + options.firstOption + '</label>');
            html.push('</div>');
            this.indexKey++;
            html.push('<div class="item">');
            html.push('<input #{sync}="' + this.indexKey + '" name="#{n}" id="' + this.getInputId() + '" type="checkbox" value="' + options.secondOption + '"/>');
            html.push('<label #{sync}="' + this.indexKey + '" for="' + this.getInputId() + '" empty="false" class="custext">' + options.secondOption + '</label>');
            html.push('</div>');
            this.indexKey++;
            html.push('<div class="item">');
            html.push('<input #{sync}="' + this.indexKey + '" name="#{n}" id="' + this.getInputId() + '"  type="checkbox" value="' + options.thirdOption + '"/>');
