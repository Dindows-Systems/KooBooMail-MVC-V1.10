...
(function ($) {
    ...
    var options = {
        ...
        unforamtText: 'Remove Format',
        horizontalRuler: 'insert horizontal ruler'
    };

    // override text resource
    if (window.__localization) { $.extend(options, __localization.toolbarButton_js); }
    ...
    */
    ...
    yardi.extend(unformatButton, toolbarButton, {
        buildHtml: function () {
            return '<span class="kb-btn-unformat" title="' + options.unformat + '">' + options.unforamtText + '</span>';
